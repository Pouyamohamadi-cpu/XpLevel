...
xabs = ctypes.CDLL('sh-lib/libabsvalue.so')
xabs.absvalue.restype = ctypes.c_int
xabs.absvalue.argtypes = [ctypes.c_int]

start_time = time.time()

search_text = '      createMain'
funcm = '@'
infosys = "lib-main/infosys.xple"
escape = "lib-main/escape.xple"
peep = "lib-main/peep.xple"
peep2 = "lib-main/peep_emulator.xple"
def onMainModule(bnb):
  ImportManager.xple(bnb)
        ...
        try:
            ...
            if search_text in content:
                ...
                if "      endMain" in content:
                    ...
                    content = replace_outside_strings(content,'exit()','end')
